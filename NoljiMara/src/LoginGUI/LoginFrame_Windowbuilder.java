...
import KioskGUI.MemberMain_Windowbuilder;
import KioskGUI.NonmemberMain_Windowbuilder;
	...
	public LoginFrame_Windowbuilder() {
		...
		btn비회원주문Button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
					...
					dispose();
					setVisible(false) ;
					new NonmemberMain_Windowbuilder().setVisible(true) ;
			}
});
		...
		loginBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(result == 1) {
					...
					dispose();
					setVisible(false) ;
					new MemberMain_Windowbuilder().setVisible(true) ;
