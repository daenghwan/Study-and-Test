...
public class Nonmember_Takeout extends JFrame {
    
	int count = 0;
	int total = 14000; // 기본 14000원 변수 total에 저장.
    String show = "";
    
    
    
    public Nonmember_Takeout() {
        // 디자인단
        // 프레임 설정단
        JFrame frame = new JFrame("비회원 포장");
        ...
        ImageIcon icon[] = new ImageIcon[menu.length]; // 이미지아이콘 선언
        Image Img[] = new Image[menu.length]; // 이미지 넣는다고 선언
        Image changedIcon[] = new Image[menu.length]; // 아이콘 모양 변경 선언
